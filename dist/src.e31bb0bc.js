...
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js"}],"views/partials/splash.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"views/pages/signin.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","moment":"../node_modules/moment/moment.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
class UserAPI {
  ...
  async addAppointment(appointmentId) {
    // validate
    if (!appointmentId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/bookings"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding appointment');
    } // convert response payload into json - store as data
  ...
  async cancelAppointment(appointmentId) {
    ...
    console.log(appointmentId); // fetch the json data
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.email, this.user.bio, this.user.accessLevel, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5())), () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"AppointmentAPI.js":[function(require,module,exports) {
"use strict";
...
var _default = new AppointmentAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/appointments.js":[function(require,module,exports) {
"use strict";
...
var _AppointmentAPI = _interopRequireDefault(require("../../AppointmentAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n\n      <style>\n        .filter-menu {\n          justify-content: center;\n          display: flex;\n        }\n\n        .filter-menu > div {\n          margin-right: 2em;\n        }\n\n        sl-button.filter-btn::part(base) {\n          /* Set design tokens for height and border width */\n          --sl-input-height-medium: 48px;\n          margin: 2px;\n          border-radius: 5em;\n          background-color: #ffffff;;\n          color: #878787;\n          font-size: 1.125rem;\n          box-shadow: 0px 0px 10px #0002;\n          transition: var(--sl-transition-medium) transform ease, var(--sl-transition-medium) border ease;\n        }\n        \n        sl-button.filter-btn::part(base):hover {\n          transform: scale(1.05) rotate(-1deg);\n        }\n        \n        sl-button.filter-btn::part(base):active {\n          background-color: #198261;\n          transform: scale(1.05) rotate(-1deg) translateY(2px);\n          }\n       \n      </style>\n\n      <va-app-header title=\"BOOK NOW\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">      \n      <h2>", "</h2>\n      <h1 class =\"animate__animated animate__zoomIn\">BOOK NOW</h1>\n\n        <div class=\"filter-menu\">\n          <div>\n            <h2>Filter by:</h2>\n          </div>\n            <div>\n              <strong>Name</strong>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Dr Xuan\" @click=", ">Dr Xuan</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Dr Reid\" @click=", ">Dr Reid</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Dr Smith\" @click=", ">Dr Smith</sl-button>\n            </div>\n            <div>\n              <strong>Day</strong>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Monday\" @click=", ">Mon</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Tuesday\" @click=", ">Tues</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Wednesday\" @click=", ">Wed</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Thursday\" @click=", ">Thurs</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Friday\" @click=", ">Fri</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"day\" data-match=\"Saturday\" @click=", ">Sat</sl-button>\n            </div>\n            <div>\n              <strong>Time</strong>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"time\" data-match=\"9:00-11:00\" @click=", ">9:00-11:00</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"time\" data-match=\"11:00-13:00\" @click=", ">11:00-13:00</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"time\" data-match=\"13:00-15:00\" @click=", ">13:00-15:00</sl-button>\n                <sl-button class=\"filter-btn\" size=\"small\" data-field=\"time\" data-match=\"15:00-17:00\" @click=", ">15:00-17:00</sl-button>\n            </div\n            <div>\n              <sl-button class= \"primary\" size=\"small\" @click=", ">Clear Filters</sl-button>\n            </div>\n        \n     \n        <div class= \"doctors-grid\">\n        ", "\n        </div>\n\n      <div class=\"button\">\n        <p>&nbsp;</p>\n        <sl-button class=\"secondary\" @click=", ">CANCEL</sl-button>\n      </div>\n    </div>\n  "]);
...
class AppointmentsView {
  ...
  async filterAppointments(field, match) {
    // validate
    if (!field || !match) return; // get refresh copy of appointments

    this.appointments = await _AppointmentAPI.default.getAppointments();
    let filteredAppointments; // name
  ...
  handleFilterBtn(e) {
    ...
    const match = e.target.getAttribute("data-match"); // filter appointments
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.appointments == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.appointments.map(appointment => (0, _litHtml.html)(_templateObject4(), appointment._id, appointment.name, appointment.day, appointment.time, JSON.stringify(appointment.user), appointment.image, appointment.bio))), () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new AppointmentsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../utils":"utils.js","../../AppointmentAPI":"AppointmentAPI.js","../../Toast":"Toast.js"}],"views/pages/newAppointment.js":[function(require,module,exports) {
"use strict";
...
class NewAppointmentView {
  ...
  async newAppointmentHandler(e) {
    ...
    try {
      await _AppointmentAPI.default.newAppointment(formData);

      _Toast.default.show('Appointment Added');
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newAppointmentHandler, _Auth.default.currentUser._id, _Auth.default.currentUser.lastName, _Auth.default.currentUser.bio, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new NewAppointmentView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../AppointmentAPI":"AppointmentAPI.js","../../Toast":"Toast.js"}],"views/pages/bookings.js":[function(require,module,exports) {
"use strict";
...
function _templateObject6() {
  const data = _taggedTemplateLiteral(["\n        <sl-button class=\"primary\" @click=", ">BOOK NEW</sl-button>\n        "]);
...
function _templateObject5() {
  const data = _taggedTemplateLiteral(["\n        <sl-button class=\"primary\" @click=", ">+ Appointment</sl-button>\n        "]);
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"YOUR BOOKINGS\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h2>", "'s</h2>\n        <h1 class =\"animate__animated animate__zoomIn\">APPOINTMENTS</h1>\n        \n          <div class=\"doctors-grid\">\n            ", "\n      </div>\n\n      <div class=\"button\">\n        <p>&nbsp;</p>\n        ", " \n        ", "\n        <p>&nbsp;</p>\n        <sl-button class=\"secondary\" @click=", ">LOG OUT</sl-button>  \n      </div>      \n    "]);
...
class BookingsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.appointments == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.appointments.map(appointment => (0, _litHtml.html)(_templateObject4(), appointment._id, appointment.name, JSON.stringify(appointment.user), appointment.image, appointment.day, appointment.time))), _Auth.default.currentUser.accessLevel == 2 ? (0, _litHtml.html)(_templateObject5(), () => (0, _Router.gotoRoute)('/newAppointment')) : "", _Auth.default.currentUser.accessLevel == 1 ? (0, _litHtml.html)(_templateObject6(), () => (0, _Router.gotoRoute)('/appointments')) : "", () => (0, _Router.gotoRoute)('/signin'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new BookingsView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js","../../AppointmentAPI":"AppointmentAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _newAppointment = _interopRequireDefault(require("./views/pages/newAppointment"));
...
const routes = {
  ...
  '/newAppointment': _newAppointment.default,
  '/': _bookings.default,
  '404': _.default,
...
},{"./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/appointments":"views/pages/appointments.js","./views/pages/newAppointment":"views/pages/newAppointment.js","./views/pages/bookings":"views/pages/bookings.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n          <a href=\"/appointments\" @click=\"", "\">Book New</a>\n        "]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n          <a href=\"/newAppointment\" @click=\"", "\">Add Appointment</a>\n        "]);
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n          <a href=\"/newAppointment\" @click=\"", "\">+ APPOINTMENT</a>\n        "]);
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  menuClick(e) {
    ...
    appSideMenu.addEventListener('sl-after-hide', () => {
      // go to route after menu is hidden
      (0, _Router.gotoRoute)(pathname);
    });
  }

  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, _Router.anchorRoute, _Router.anchorRoute, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject2(), _Router.anchorRoute) : "", e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3(), this.menuClick) : "", this.user.accessLevel == 1 ? (0, _litElement.html)(_templateObject4(), _Router.anchorRoute) : "", this.menuClick, () => _Auth.default.signOut());
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-appointment.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    <style>\n\n    .doctor {\n      text-align: center;\n      padding-bottom: 2em;\n    }\n\n    img {\n      width: 20em;\n    }\n\n    h2 {\n     text-align: center;\n    }\n\n    \n    </style>\n\n    <sl-card class= \"doctor\"> \n      <img slot=\"image\" src=\"", "/images/", "\" />\n      <h2>", "</h2>\n      <p>", "</p>\n      <p>", "</p>\n      <sl-button @click=", ">Bio</sl-button>\n      <sl-button @click=", ">BOOK</sl-button>\n    </sl-card>\n  "]);
...
customElements.define('va-appointment', class Appointment extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  bioHandler() {
    ...
    dialogEl.className = 'doctor-dialog'; // sl-dialog content

    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.name, this.name, this.bio);
  ...
  async addAppointmentHandler() {
    try {
      await _UserAPI.default.addAppointment(this.id);

      _Toast.default.show('Successfully Booked');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.day, this.time, this.bioHandler.bind(this), this.addAppointmentHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js","./../UserAPI":"UserAPI.js","./../Toast":"Toast.js","../AppointmentAPI":"AppointmentAPI.js","../views/pages/appointments":"views/pages/appointments.js"}],"components/va-booking.js":[function(require,module,exports) {
"use strict";
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n    \n    <style>\n    .doctor {\n      text-align: center;\n    }\n\n    img {\n      width: 20em;\n    }\n\n    h2 {\n     text-align: center;\n    }\n\n    .sl-button {\n      color: var(--brand-color);\n      left: 50%;\n    }\n    </style>\n\n    <sl-card class= \"doctor\"> \n      <img slot=\"image\" src=\"", "/images/", "\" />\n      <h2>", "</h2>\n      <p>", "</p>\n      <p>", "</p>\n     \n\n      <sl-button @click=", ">Cancel</sl-button>\n    </sl-card>\n    \n  "]);
...
customElements.define('va-booking', class Appointment extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  bioHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.name, this.name, this.bio, this.addAppointmentHandler.bind(this));
    (0, _litHtml.render)(dialogContent, dialogEl); // append to document.body
  ...
  async addAppointmentHandler() {
    ...
    _AppointmentAPI.default.deleteAppointment(this.id);
  }

  async cancelAppointmentHandler() {
    try {
      await _UserAPI.default.cancelAppointment(this.id);

      _Toast.default.show('Successfully Canceled');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.day, this.time, this.cancelAppointmentHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","../Toast":"Toast.js","../AppointmentAPI":"AppointmentAPI.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
require("./components/va-appointment");

require("./components/va-booking");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-appointment":"components/va-appointment.js","./components/va-booking":"components/va-booking.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
